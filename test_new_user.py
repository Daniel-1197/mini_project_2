...
def test_create_newuser(login):
    ...
    page.select_employee('Admin  Admin123')
    ...
    print("\n New User 'New_user' created successfully.")

def test_new_user_login(setup):
    driver = setup
    wait = WebDriverWait(driver,20)
    wait.until(EC.visibility_of_element_located((By.NAME, "username"))).send_keys("New_user")
    wait.until(EC.visibility_of_element_located((By.NAME, "password"))).send_keys("User@123")
